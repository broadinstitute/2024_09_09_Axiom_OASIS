...
- `image_archive/` contains the small manifest-driven TIFF-to-JPEG-XL converter and a validated 1,000-row manifest sample from the `cpg0037-oasis/axiom` dataset.
...
See [image_archive/README.md](image_archive/README.md) to convert a prepared TIFF manifest and verify every JPEG XL output.
...
The locked pipeline and paper test commands are in [paper/README.md](paper/README.md), and the archive test command is in [image_archive/README.md](image_archive/README.md).
